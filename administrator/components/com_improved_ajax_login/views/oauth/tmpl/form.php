...
<div class="col width-50" style="width:34%; float:left">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<h3><?php echo $this->oauth->name;?></h3>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td width="100" align="right" class="key">
				<label for="app_id">
					<?php echo JText::_( 'App/Client ID' ); ?>:
				</label>
			</td>
			<td>
		...
		<tr>
			<td width="100" align="right" class="key">
				<label for="app_secret">
					<?php echo JText::_( 'App/Client secret' ); ?>:
				</label>
			</td>
			<td>
    ...
    <tr><td colspan="2"><hr /></td></tr>
		<tr>
			<td valign="top" align="right" class="key">
				<label>
					<b><?php echo JText::_( 'Get App/Client ID and secret' ); ?>:</b>
				</label>
			</td>
			<td>
        <a href="<?php echo $this->oauth->create_app; ?>" target="_blank"><?php echo $this->oauth->create_app; ?></a><br />
        Click above, log in and follow the tutorial<br />
			</td>
		</tr>
		<tr>
			<td valign="top" align="right" class="key">
				<label>
					<?php echo JText::_( 'App/Site Domain' ); ?>:
				</label>
			</td>
			<td>
		...
		<tr>
			...
			<td>
        <textarea readonly="readonly" style="cursor:text" onclick="this.select()" style="width:240px"><?php echo JURI::root().'index.php?option=com_improved_ajax_login&task='.$this->oauth->alias;?></textarea>
			</td>
		</tr>
	</table>
	</fieldset>
</div>
<div id="tutor" class="col width-50" style="display:block; width:66%; float:left">
	<fieldset class="adminform">
