 ...
 * @subpackage 	Jcrm
 */
class JcrmModelJcrmcontacts extends JModel{
	/**
	...
	public function &getData(){
		// Load the data
		if (empty( $this->_data )) {
			$query = 'SELECT * FROM `#__jcrm_contacts` WHERE `id` = '.$this->_id;
...
// mcm code 
		...
		$data['mailing'] = JRequest::getVar('mailing', '', 'post', 'int');
		$data['account_id'] = JRequest::getVar('account_id', '', 'post', 'int');
		$data['referent_postgradutate'] = JRequest::getVar('referent_postgradutate', '', 'post', 'int');
		$data['active'] = JRequest::getVar('active', '', 'post', 'int');
// mcm code 
