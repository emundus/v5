...
$controllers = explode(',', 'panel,config');
...
foreach($controllers as $controller){
	...
	JSubMenuHelper::addEntry(JText::_( 'MENU_' . $controller ), "index.php?option=com_emundus&controller=".$controller, ($controller == JRequest::getWord('controller')));
}
