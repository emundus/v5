...
<div id="emundusflow_new">
	<div class="part">
		...
		<div class="bar">
			<div class="progression" style="width: <?php echo $forms ?>%">
	...
	<div class="part">
		...
		<div class="bar">
			<div class="progression" style="width: <?php echo $attachments ?>%">
	...
	<?php 
		if ($sent>0) {
			...
			echo'<div class="part">
					...
					<div class="bar">
						<div class="progression" style="width: 100%">
			...
			if($cpt>0)
				echo '<div class="renew_application">
						<a href="index.php?option=com_emundus&view=renew_application"><img src="'.JURI::Base().'media/com_emundus/images/icones/renew.png" width="25" length="25" align="middle" />
