...
<table align="center">
	<tr>
		...
		<td class="flowfleche"></td>
		<td id="flowsent" class="flow"><img src="modules/mod_emundusflow/style/images/<?php echo $sent>0?'ok.png':'no.png'; ?>" width="25" length="25" alt="<?php echo $sent>0?'Sent':'Not sent'; ?>" align="middle" /><?php echo $sent>0?JText::_('APPLICATION_SENT'):JText::_('APPLICATION_NOT_SENT'); ?></td>
	</tr>
</table>
</fieldset>
</div>