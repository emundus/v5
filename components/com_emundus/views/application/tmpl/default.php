...
<div id="accordion">
	...
	<div class="actions">
	<?php
	echo '<a class="modal" target="_self" rel="{handler:\'iframe\',size:{x:window.getWidth()*0.8,y: window.getHeight()*0.8},onClose:function(){delayAct('.$this->student->id.');}}" href="'.JURI::Base().'index.php?option=com_emundus&view=email&tmpl=component&sid='.$this->student->id.'">'; ?>
