 ...
 * @package		Emundus
 * @copyright	(C) 2008 Décision Publique : http://www.decisionpublique.fr. All rights reserved.
 * @license		GNU General Public License
 * @description	Tableau des dossiers à évaluer - report = candidate_to_evaluate
 */
